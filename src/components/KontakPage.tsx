...
const contacts = [
  ...
  },
  {
    ...
    color: 'from-sakura/15 to-sakura/5',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
  ...
  return (
    <div className="px-6 pt-8 pb-6">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-xs text-primary/55 mt-2 font-semibold tracking-widest uppercase">
          ...
          return (
            ...
            >
              <div className="glass-zen-card px-5 py-4 flex items-center gap-4">
                <div className={`w-11 h-11 rounded-full bg-gradient-to-br ${contact.color} border border-border flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform duration-300`}>
                ...
                <ExternalLink className="w-3.5 h-3.5 text-foreground/[0.08] group-hover:text-primary/45 transition-colors duration-300 shrink-0" />
              </div>
            </a>
          )
        })}
