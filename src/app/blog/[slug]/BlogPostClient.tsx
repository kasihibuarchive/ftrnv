  ...
  return (
    <div className="min-h-screen nature-bg relative flex flex-col">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
        <div
          className="absolute top-[-5%] left-[10%] w-[350px] h-[350px] rounded-full opacity-[0.07] animate-float-1"
          style={{
        ...
        />
        <div
          className="absolute bottom-[5%] right-[5%] w-[300px] h-[300px] rounded-full opacity-[0.06] animate-float-2"
          style={{
      ...
      <header className="glass-zen-header sticky top-0 z-50">
        <div className="max-w-2xl mx-auto px-6 h-14 flex items-center justify-between">
          <Link
            href="/"
            className="flex items-center gap-2 text-foreground/55 hover:text-foreground transition-colors duration-200"
          >
          ...
          <button
            onClick={handleShare}
            className="flex items-center gap-1.5 text-foreground/35 hover:text-primary transition-colors duration-200"
          >
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full">
          ...
          <div className="relative w-full h-[45vh] min-h-[280px] max-h-[420px] overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 px-6 pb-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="flex items-center gap-1.5 text-[11px] text-foreground/55 font-medium">
              ...
              <div className="flex items-center justify-between mt-3">
                <span className="flex items-center gap-1.5 text-[11px] text-foreground/40 font-medium">
        ...
        <div className="px-6 py-4">
          <div className="glass-zen-card px-4 py-3 flex items-center justify-between">
            <span className="text-[11px] text-foreground/35 font-medium">Bagikan artikel ini</span>
            <div className="flex items-center gap-3">
              <button
                onClick={shareToWhatsApp}
                className="w-8 h-8 rounded-full flex items-center justify-center bg-primary/8 hover:bg-primary/15 transition-colors duration-200"
                title="WhatsApp"
              >
        ...
        <div className="px-6 pb-8">
          ...
          <div className="glass-zen-card px-5 py-4 flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-foreground/70">Tertarik dengan artikel ini?</p>
              <p className="text-[11px] text-foreground/35 font-medium mt-0.5">Bagikan ke teman-temanmu!</p>
            </div>
