...
import { readingTime } from '@/lib/utils-shared'
    ...
    <div className="relative flex flex-col">
      ...
      <header className="glass-zen-header sticky top-0 z-50">
        <div className="max-w-2xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <button
            onClick={handleShare}
            className="flex items-center gap-1.5 text-foreground/30 hover:text-primary transition-colors duration-200"
          >
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full">
        {/* Hero Image — always dark gradient + bright text */}
        {blog.coverImage && (
          <div className="relative w-full h-[45vh] min-h-[280px] max-h-[420px] overflow-hidden">
            ...
            {/* Hero overlay content — always bright */}
            <div className="absolute bottom-0 left-0 right-0 px-6 pb-6">
              <div className="flex items-center gap-3 mb-3">
                {blog.category && (
                  <span className="bg-white/15 backdrop-blur-sm text-white/90 px-2.5 py-1 text-[10px] font-bold tracking-wider uppercase rounded-full inline-flex items-center gap-1.5">
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <span className="text-[11px] text-foreground/30 font-medium">Bagikan artikel ini</span>
            <div className="flex items-center gap-2">
              <button
                onClick={shareToWhatsApp}
                className="w-7 h-7 rounded-full flex items-center justify-center hover:bg-primary/8 transition-colors duration-200"
                title="WhatsApp"
              >
                <svg className="w-3 h-3 text-foreground/25" viewBox="0 0 24 24" fill="currentColor">
              ...
              <button
                ...
                title="Salin Link"
              >
                <Share2 className="w-3 h-3 text-foreground/25" />
              </button>
            </div>
          </div>
        </div>
        ...
        {/* Bottom share bar — seamless */}
        <div className="px-6 pb-8">
          <div className="zen-divider mb-6" />
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-foreground/60">Tertarik dengan artikel ini?</p>
              <p className="text-[11px] text-foreground/30 font-medium mt-0.5">Bagikan ke teman-temanmu!</p>
            </div>
            <div className="flex items-center gap-2">
              <button
                onClick={shareToWhatsApp}
